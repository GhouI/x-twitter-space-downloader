...
```bash
python twitter_space_dl.py "PASTE_PLAYLIST_URL_HERE" "PASTE_KEY_URL_HERE" --cookie "auth_token=PASTE_TOKEN_HERE; ct0=PASTE_CT0_HERE"
```
...
Depends on how long the original space.
